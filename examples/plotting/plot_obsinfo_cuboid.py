...
def main():
    ...
    obs_info_trans_lengths = data_dict["obs_info"][4:, 4:] # Remove quaternion
    breakpoint()
    ...
    ax.scatter(learned_vertices[:, 0], learned_vertices[:, 1], learned_vertices[:, 2], marker='o', s=30, color='red')#color=scalarMap.to_rgba(vertex_infos))
