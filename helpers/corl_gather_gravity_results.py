...
GRAVITY_FRACTIONS = {0: 0.0, 1: 0.5, 2: 1.0, 3: 1.5, 4: 2.0}
...
EXPERIMENT_DICT = {"system": None, "prefix": None, "gravity_sweep": None}
...
for experiment in EXPERIMENTS.keys():
    ...
    for run in os.listdir(runs_path):
        ...
        if run_dict["structured"]:
            ...
            params_dict = get_physical_parameters(system, body_names, best_system_state)
