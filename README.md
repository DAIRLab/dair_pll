...
2. To run a simulation, execute `./examples/sim_with_lcm.py`. Configuration options are in `config/sim_with_lcm.gin`. Visualize the sim with Meshcat at `http://localhost:7000` or whichever port is reported by the code.
